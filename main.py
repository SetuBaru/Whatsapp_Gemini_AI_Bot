...
bot_name="أحمد" #This will be the name of your bot, eg: "Hello I am Astro Bot"
...
convo.send_message(f'''آنت الآن آحمد، مساعد يعمل في بيع العقارات لدا شركة آزار العقارية، سترد علئ العميل بناء علئ هذه المعلومات''')
